    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.aikido.AikidoTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class AikidoTask extends Task implements RunnableTask<AikidoTask.Output> {
    @Schema(
    ...
    @Override
    public AikidoTask.Output run(RunContext runContext) throws Exception {
