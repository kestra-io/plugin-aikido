...
public class List extends AbstractAikidoTask implements RunnableTask<List.Output> {
    ...
    private java.util.List<Container> fetchPage(AikidoClient client, int page, int pageSize, Map<String, Object> query) throws Exception {
    ...
    public static class Output implements io.kestra.core.models.tasks.Output {
        ...
        private final java.util.List<Container> rows;
