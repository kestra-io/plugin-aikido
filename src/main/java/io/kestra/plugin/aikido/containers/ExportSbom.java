...
@Schema(
    ...
    description = "Downloads the license and package overview for a container image and stores it to internal storage. Fails with an actionable message if the container has no completed scan yet — run `Scan` first."
)
@Plugin(
    examples = {
        @Example(
