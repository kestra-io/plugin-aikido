    ...
    examples = {
        @Example(
            ...
            code = """
                ...
                tasks:
                  - id: scan
                    type: io.kestra.plugin.aikido.repositories.ScanRepository
...
public class ScanRepository extends AbstractScanTask implements RunnableTask<ScanRepository.Output> {
