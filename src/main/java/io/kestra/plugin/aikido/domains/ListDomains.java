    ...
    examples = {
        @Example(
            ...
            code = """
                ...
                tasks:
                  - id: list_domains
                    type: io.kestra.plugin.aikido.domains.ListDomains
...
public class ListDomains extends AbstractAikidoTask implements RunnableTask<ListDomains.Output> {
    ...
    private List<Domain> fetchPage(AikidoClient client, int page, int pageSize) throws Exception {
    ...
    public static class Output implements io.kestra.core.models.tasks.Output {
        ...
        private final List<Domain> rows;
