    ...
    examples = {
        @Example(
            ...
            code = """
                ...
                tasks:
                  - id: compliance
                    type: io.kestra.plugin.aikido.compliance.GetComplianceReport
...
public class GetComplianceReport extends AbstractAikidoTask implements RunnableTask<GetComplianceReport.Output> {
