    ...
    examples = {
        @Example(
            ...
            code = """
                ...
                tasks:
                  - id: list_clouds
                    type: io.kestra.plugin.aikido.clouds.ListClouds
...
public class ListClouds extends AbstractAikidoTask implements RunnableTask<ListClouds.Output> {
    ...
    private List<Cloud> fetchPage(AikidoClient client, int page, int pageSize) throws Exception {
