...
@KestraTest
@WireMockTest
class IssueTriggerTest {
    @Inject
    private RunContextFactory runContextFactory;

    private IssueTrigger trigger(WireMockRuntimeInfo wireMockRuntimeInfo, int threshold) {
        return IssueTrigger.builder()
            .id(IdUtils.create())
            .type(IssueTrigger.class.getName())
